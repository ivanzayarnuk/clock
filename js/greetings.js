...
const USERKEY_LS = 'currentUsername',   // ключ для localStorage в котом сохраняем значение 
      SHOWING_CN = 'showing';
      
function saveUserName(name){
    localStorage.setItem(USERKEY_LS,name);
}
...
function loadUserName() {
    const currentUsername = localStorage.getItem(USERKEY_LS);
